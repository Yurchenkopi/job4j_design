...
class QuickListTest {
    ...
    @Test
    void whenSortByNameAscThenOk() {
        User user1 = new User(1, "11");
        User user2 = new User(1, "333");
        User user3 = new User(3, "22");
        User user4 = new User(-4, "111");
        User user5 = new User(4, "77");
        User user6 = new User(6, "66");
        ...
        assertThat(result).containsExactly("11", "111", "22", "333", "66", "77");
    }
    ...
    void whenSortByNameDcsThenOk() {
        ...
        QuickList.quickSort(listUser, comparator);
        List<String> result = listUser.stream().map(User::getName).toList();
        assertThat(result).containsExactly("77", "66", "333", "22", "111", "11");
    }
